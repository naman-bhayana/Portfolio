...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="px-4 sm:px-6 lg:px-8">
      <h2 className="text-center text-3xl sm:text-4xl font-bold text-white mt-4 mb-6 sm:mb-8 md:mb-12">
        My Projects
      </h2>
      <div className="text-white flex flex-row flex-wrap justify-center items-center gap-2 sm:gap-3 py-4 sm:py-6 px-2">
        <ProjectTag
      ...
      <ul ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 max-w-7xl mx-auto">
